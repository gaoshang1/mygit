...
public class ProgressFillActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        mFragmentList.add(new ProgressFillFragment().newInstance("0,1,4"));
        mFragmentList.add(new ProgressFillFragment().newInstance("2"));
