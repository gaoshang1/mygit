...
public class TrackConfirmAdapter extends RecyclerView.Adapter<TrackConfirmAdapter.MyViewHolder>
{
    Context context;
    List<GoalListBean> mData;

    public TrackConfirmAdapter(Context context, List<GoalListBean> mData)
    {
        this.mData = mData;
...
//        holder.listview.addItemDecoration(new MyDividerItemDecoration(context, LinearLayoutManager.VERTICAL));
        TrackConfirm2Adapter adapter = new TrackConfirm2Adapter(context, mData.get(position).getSub(), 1);
