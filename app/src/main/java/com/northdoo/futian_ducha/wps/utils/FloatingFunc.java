...
public class FloatingFunc {
	...
	private final static String TAG = "FloatingFunc";

	private static boolean isViewAdd = false;
	...
	public static void close(Context context) {
		...
		Log.e(TAG, "view_obj_before===" + view_obj);
		if (view_obj != null && view_obj.isShown()) {
			WindowManager wm = (WindowManager) context
					.getSystemService(Activity.WINDOW_SERVICE);
			wm.removeView(view_obj);
			Log.e(TAG, "has been removed");
		}

		Log.e(TAG, "view_obj_after===" + view_obj);
	}
	...
	public static void setViewAdd(boolean isViewAdd) {
		FloatingFunc.isViewAdd = isViewAdd;
	}
